...
* 1. 在Visual Studio Code點選 ```Publish to GitHub```
  <img src="https://raw.githubusercontent.com/michael54856/aiot0531/master/Image/step_1_publishToGithub.png" width="80%">
* 2. 點選 ```Publish to GitHub public repository```
  <img src="https://raw.githubusercontent.com/michael54856/aiot0531/master/Image/step_1_selectPublic.png" width="50%">
